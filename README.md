...
### Most extreme first-day moves
<img src="reports/figures/11_top_bottom_ipos.png" width="900">

*The 15 biggest first-day winners (left) and losers (right), coloured by sector. The big winners cluster in **Healthcare** (Karuna, Belite Bio, Praxis, Shockwave) and **Technology** (Palantir, Cloudflare, CrowdStrike); the big losers are mostly de-listed micro-caps shown at exactly −100%, a reminder that the upstream price field is brittle for tickers that later collapsed.*
